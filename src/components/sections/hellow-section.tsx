  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-justify">
        ...
        <strong className="text-main-dark underline dark:text-main">NextJs</strong>,
        my second favorite framework, It came up, to fix some difficulties of
        the past two... SEO, the capavility to be find easily on web browsers,
        just as Google, and some other things, with Server Side Rendering, a
        complete different way to work. Perfect for static sites, just like this portfolio, or even better, marketplaces...
      </p>
      <p></p>
    </div>
  )
